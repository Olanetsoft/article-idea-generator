...
export default function Footer() {
  ...
  return (
    <footer className="text-center border-t border-slate-200 dark:border-dark-border sm:h-15 sm:py-2 py-4 px-5 space-y-2 sm:mb-0 dark:bg-black dark:text-zinc-300 w-full bg-white mt-auto">
